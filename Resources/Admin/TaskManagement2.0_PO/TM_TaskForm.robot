...
*** Variables ***
${TM_TaskForm_Add_Assignee_Icon} =          xpath=//div[@class='task-assignee']/tm-assignee/div/tm-search/div/a/div/tm-photo
...
${TM_TaskForm_Task_Name_TextBox} =          xpath=//div[@class='task-name']/input
...
${TM_TaskForm_Tag_Label} =                  xpath=//li[@class='tag-list ng-star-inserted']/span[text()='abc']
${TM_TaskForm_Tag_in_dropdown} =            xpath=//li[@class='menu-list-item']/a[text()='abc']
${TM_TaskForm_Delete_Tag_Icon} =            xpath=//li[@class='tag-list ng-star-inserted']/span[text()='abc']/i
...
${TM_TaskForm_Follower_Tool_Tip} =          xpath=//popover-container[@role="tooltip"]/div[contains(text(),'abc')]
...
Search and select Existing Tag
    [Arguments]  ${Tag_Name}
    click element                   ${tm_taskform_add_tags_search_field}
    input text                      ${tm_taskform_add_tags_search_field}            ${Tag_Name}
